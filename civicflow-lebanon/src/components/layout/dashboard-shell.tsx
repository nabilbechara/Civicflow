          ...
          <nav className="mt-8 space-y-2">
            {[
              ...
              <a
                key={item}
                href="#"
                className="block rounded-2xl border border-transparent px-4 py-3 text-sm text-slate-300 transition hover:border-white/10 hover:bg-white/[0.04] hover:text-white"
              >
                {item}
              </a>
            ))}
